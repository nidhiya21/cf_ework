...
<body> 
        <cfif StructKeyExists(form,'formSubmit')> 
                <cfif structKeyExists(url, "id")> 
                        <cfinvoke component="components/cf_28" method="updatePage" returnvariable="result">
                ...
                <cfelseif IsDefined("form.pagename")  and  IsDefined("form.pagedesc")>
                        <cfinvoke component="components/cf_28" method="insertPage" returnvariable="result">
                                <cfinvokeargument name="pagename"  value = "#form.pagename#" />
                                <cfinvokeargument name="pagedesc"  value = "#form.pagedesc#" />
                        </cfinvoke>
                        <cfif result GT 0>
